    ...
    <Flex w="full" minH="100vh" bg="#E6E6E6">
            ...
            <RouterLink to="/projects" style={{ width: '100%' }}>
              ...
              >
                <Box
                  w="20px"
                  h="20px"
                  bg={isActive('/projects') ? "white" : "transparent"}
                  border={isActive('/projects') ? "none" : "2px solid white"}
                  borderRadius="sm"
                ></Box>
      ...
      <Box flex="1" p={8} bg="#E6E6E6">
        <Flex justifyContent="space-between" alignItems="center" mb={8}>
          <Heading as="h2" size="2xl" color="black">Mis Proyectos</Heading>
        </Flex>
        <Text color="gray.500">Contenido de la sección de proyectos (lista de proyectos, filtros, etc.) irá aquí.</Text>
