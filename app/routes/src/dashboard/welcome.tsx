    ...
    <Flex w="full" minH="100vh" bg="#E6E6E6"> 
      ...
      >
       <Box w="full" p={6} bg="#001728">
        ...
        >
          ...
          <VStack align="flex-start" gap={4} w="full">
            <RouterLink to="/welcome" style={{ width: '100%' }}>
              <HStack
                ...
                _hover={{ bg: "#002C4B" }} 
              >
                <Box w="20px" h="20px" bg="white" borderRadius="sm"></Box>
            ...
            <RouterLink to="/tasks" style={{ width: '100%' }}>
              <HStack
                ...
                _hover={{ bg: "#002C4B" }}
              >
                <Box w="20px" h="20px" border="2px solid white" borderRadius="sm"></Box>
          ...
          <HStack gap={3} mt="auto" w="full" p={2} borderRadius="md" bg="#001F35">
      ...
      <Box flex="1" p={8} bg="#E6E6E6">
        <Flex justifyContent="space-between" alignItems="center" mb={8}>
          <Heading as="h2" size="2xl" color="black">Bienvenido</Heading>
        </Flex>
        <Text color="gray.500">Contenido principal del dashboard (tareas y proyectos) irá aquí.</Text>
