...
export const loginUser = async (
  ...
  localStorage.setItem(import.meta.env.VITE_USER_EMAIL_KEY, data.email); // Guardar el email
  return data;
};
...
export const logoutUser = async (): Promise<void> => {
  ...
  localStorage.removeItem(import.meta.env.VITE_USER_EMAIL_KEY); // Eliminar el email al cerrar sesión
};
